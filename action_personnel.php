...
if ($_GET['del'] == 1) {
    ...
    delete("tb_user","id_user = '".$_GET['id_del']."' ");
...
if ($_GET['insert'] == 1) {
            ...
            <table width="100%" border="0" align="center">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input type="radio" name="status_boss" value="Y"> เป็นหัวหน้า
                    </td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
        ...
        <div class="modal-body">
            <table width="100%" border="0" align="center">
                ...
                <tr>
                    ...
                    <td><input type="text" name="id_number" id="id_number" class="form-control"
                               value="<?php echo $res_show['id_number']; ?>"></td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    ...
                    <td><input type="text" name="name" id="name" class="form-control"
                               value="<?php echo $res_show['name']; ?>"></td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                ...
                <tr>
                    <td align="right">ชื่อย่อ :</td>
                    <td><input type="text" name="shot_name" id="shot_name" class="form-control"
                               value="<?php echo $res_show['user_name']; ?>"></td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                ...
                <tr>
                    ...
                    <td><select name="pos" id="pos" class="form-control">
                            ...
                            while ($res_pos = mysql_fetch_array($sql_pos)) {
                                ?>
                                <option value="<?php echo $res_pos['po_id']; ?>" <?php if ($res_pos['po_id'] == $res_show['id_position']) {
                                    echo "selected";
                                } ?>><?php echo $res_pos['po_name']; ?></option>
                                <?php
                            }
                            ?>
                        </select></td>
                ...
                <tr>
                    ...
                    <td><select name="dep" id="dep" class="form-control">
                            ...
                            while ($res_dep = mysql_fetch_array($sql_dep)) {
                                ?>
                                <option value="<?php echo $res_dep['dep_id']; ?>" <?php if ($res_dep['dep_id'] == $res_show['id_department']) {
                                    echo "selected";
                                } ?>><?php echo $res_dep['dep_name']; ?></option>
                                <?php
                            }
                            ?>
                        </select></td>
                ...
                <tr>
                    <td align="right">วันที่เริ่มงาน :</td>
                    <td><input type="date" name="start_work" id="start_work" class="form-control"
                               value="<?php echo $res_show['start_work']; ?>"></td>
                </tr>
            </table>
        </div>
        <div class="modal-footer">
  ...
  start_work
    ...
    <form action="action_personnel.php" method="post">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
            <h4 class="modal-title" id="myModalLabel">รายละเอียดจำนวนวันลา
                (<?php echo $res['name'] . " " . $res['shot_name'] ?>)</h4>
        </div>
        <div class="modal-body">
            <div class="alert alert-success">อายุงาน <?php echo $res_date['s_year'] ?>
                ปี <?php echo $res_date['s_month'] ?> เดือน <?php echo $res_date['s_day'] ?> วัน
            </div>
            <table border='0' width="100%">
                <tr>
                    ...
                    <td>จำนวนที่ลา</td>
                    <td>จำนวนที่เหลือ</td>
                    <td align="right"><a class="btn btn-warning btn-xs" onclick="textUnlock()"><i
                                    class="fa fa-pencil"></i></a></td>
                </tr>
                <tr>
                    <td width="25%" align="right"><label class=" control-label">ลาป่วย : </label></td>
                    <td width="15%"><input type="text" class="form-control round-form" name="show_lea_1" id="show_lea_1"
                                           disabled="true" value=""></td>
                    <td width="15%" align="left"><input type="text" class="form-control round-form" name="lea_sick"
                                                        id="lea_sick" disabled="true"
                                                        value="<?php echo $res['lea_sick']; ?>">
                        <input type="hidden" name="update_lea" id="" value="1" class="form-control">
                        <input type="hidden" name="id" id="" value="<?php echo $_GET['id_detail']; ?>"
                ...
                <tr>
                    ...
                    <td><input type="text" class="form-control round-form" name="show_lea_2" id="show_lea_2"
                               disabled="true" value=""></td>
                    <td align="left"><input type="text" class="form-control round-form" name="lea_work" id="lea_work"
                                            disabled="true" value="<?php echo $res['lea_work']; ?>"></td>
                ...
                <tr>
                    ...
                    <td><input type="text" class="form-control round-form" name="show_lea_3" id="show_lea_3"
                               disabled="true" value=""></td>
                    <td align="left"><input type="text" class="form-control round-form" name="lea_birth" id="lea_birth"
                                            disabled="true" value="<?php echo $res['lea_birth']; ?>"></td>
                ...
                <tr>
                    ...
                    <td><input type="text" class="form-control round-form" name="show_lea_4" id="show_lea_4"
                               disabled="true" value=""></td>
                    <td align="left"><input type="text" class="form-control round-form" name="lea_soldier"
                                            id="lea_soldier" disabled="true" value="<?php echo $res['lea_soldier']; ?>">
                    </td>
                ...
                <tr>
                    ...
                    <td><input type="text" class="form-control round-form" name="show_lea_5" id="show_lea_5"
                               disabled="true" value=""></td>
                    <td align="left"><input type="text" class="form-control round-form" name="lea_sterile"
                                            id="lea_sterile" disabled="true" value="<?php echo $res['lea_sterile']; ?>">
                    </td>
                ...
                <tr>
                    ...
                    <td><input type="text" class="form-control round-form" name="show_lea_6" id="show_lea_6"
                               disabled="true" value=""></td>
                    <td align="left"><input type="text" class="form-control round-form" name="lea_ordain"
                                            id="lea_ordain" disabled="true" value="<?php echo $res['lea_ordain']; ?>">
                    </td>
                ...
                <tr>
                    ...
                    <td><input type="text" class="form-control round-form" name="show_lea_7" id="show_lea_7"
                               disabled="true" value=""></td>
                    <td align="left"><input type="text" class="form-control round-form" name="lea_other" id="lea_other"
                                            disabled="true" value="<?php echo $res['lea_other']; ?>"></td>
                    <td align="left"></td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                ...
                <tr>
                    ...
                    <td><input type="text" class="form-control round-form" name="show_lea_8" id="show_lea_8"
                               disabled="true" value=""></td>
                    <td align="left"><input type="text" class="form-control round-form" name="lea_relax" id="lea_relax"
                                            disabled="true" value="<?php echo $res['lea_relax']; ?>"></td>
                    <td align="left"> * ตั้งแต่ 1 ปี ขึ้นไป แต่ไม่ถึง 3 ปี ลาได้ 6 วัน<br>
                        ตั้งแต่ 3 ปี ขึ้นไป แต่ไม่ถึง 5 ปี ลาได้ 7 วัน<br>
                        ตั้งแต่ 5 ปี ขึ้นไป ลาได้ 8 วัน
                    </td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                ...
                <tr>
                    ...
                    <td><input type="text" class="form-control round-form" name="show_lea_9" id="show_lea_9"
                               disabled="true" value=""></td>
                    <td align="left"><input type="text" class="form-control round-form" name="lea_morning"
                                            id="lea_morning" disabled="true" value="<?php echo $res['lea_morning']; ?>">
                    </td>
                ...
                <tr>
                    <td align="right" style="vertical-align: text-top;"><label class=" control-label">ลาบ่าย : </label>
                    </td>
                    <td><input type="text" class="form-control round-form" name="show_lea_10" id="show_lea_10"
                               disabled="true" value=""></td>
                    <td align="left"><input type="text" class="form-control round-form" name="lea_afternoon"
                                            id="lea_afternoon" disabled="true"
                                            value="<?php echo $res['lea_afternoon']; ?>"></td>
                    <td align="left"> * คิดจากจำนวนวันลากิจ</td>
                </tr>
